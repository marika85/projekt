...
//////////////////////////////////////////////////////////////////////////////
% init.alg
idzdowydruku["eksportplc.prn",""]
% inita.alg
idzdowydruku["importplc.prn",""]
% umowy.alg
exitalg[0]   
...
323,kwota       # zasiˆek chorobowy 70%
...
336,kwota       # zasiˆek chorobowy 75%
...
341,kwota       # zasiˆek chorobowy 90%
...
345,ydate        # poczatek rozliczanego swiadczenia rehabilitacyjnego( dla ustalenia czy stosowac wskaŸnik rewaloryzacyjny)
// --------------------------------------------
...
"KDR_wyn_l70",323,Ekwota       # zasiˆek chorobowy 70%
...
"KDR_wyn_l75",336,Ekwota       # zasiˆek chorobowy 75%
...
"KDR_wyn_l90",341,Ekwota       # zasiˆek chorobowy 90%
...
"kdr_poczreh",345,Edata        # poczatek rozliczanego swiadczenia rehabilitacyjnego( dla ustalenia czy stosowac wskaŸnik rewaloryzacyjny)
// -----------------------------------------------------
// do prezentacji
// -----------------------------------------------------
...
55,kwota             # gotowka
56,kwota             # suma podstawa opodatkowania-pomniejszen o skˆadki emeryt i kup
...
108,Ydate            # 4.data od
109,Ydate            # 4.pocz¹tek nieobecnoœci rozliczanej na liœcie 
...
113,string,10        # 5 korekty -> x w przypadku gdy linia nie ma byc drukowana na liœcie
...
"datado4",109,Edata     # 4.4.pocz¹tek nieobecnoœci rozliczanej na liœcie 
...
"kod_chor5",113,Estring # 5 korekty -> x w przypadku gdy linia nie ma byc drukowana na liœcie
...
73,Ydate              # 4.data od 
74,Ydate              # 4.pocz¹tek nieobecnoœci rozliczanej na liœcie 
...
"datado4",74,Edata      # 4.4.pocz¹tek nieobecnoœci rozliczanej na liœcie 
...
"uzupelniany",42,Elog,"uzupe|lniany"      # uzupeˆniac wynagrodznie miesieczne
// staz
...
//if(xpracownik=="P204") okalert["podstawa_ekw="+podstawa_ekw+"$kwota_stale="+kwota_stale+"$kwota_zmienne="+kwota_zmienne+"$kwota_dlugie="+kwota_dlugie+"$wsp_ekw="+wsp_ekw+"$wymiar_prac="+wymiar_prac]
xstawka := round[podstawa_ekw/(wsp_ekw*wymiar_prac*8),2]
xzbrutto := round[xstawka,2]
if(xmnozyc) xzbrutto := roundN[xstawka,2]*xlgodzin
xzbrutton := round[xstawka,2]
...
if(xmnozyc) xzbrutto := roundN[xstawka*xlgodzin,2]
xzbrutton := xstawka
//if(xpracownik="1DL" or xpracownik=="1JL") okalert["xpracownik="+xpracownik+"$xskladnik="+xskladnik+"$xstawka="+xstawka+"$xlgodzin="+xlgodzin]
//
...
if((xrodzm1=="312" or xrodzm1=="313" or xrodzm1=="314" or xrodzm1=="315") and not(czy_uprawniony) ) rejwstawp_s["ce:lista1","@"+symlisty+tostr["#numerlisty#S:0"]]
if((xrodzm1=="316" or xrodzm1=="317" or xrodzm1=="318" or xrodzm1=="320") and not(czy_uprawniony) ) rejwstawp_s["ce:lista1","@"+symlisty+tostr["#numerlisty#S:0"]]
if((xrodzm1=="321" or xrodzm1=="322" or xrodzm1=="323" or xrodzm1=="324" or xrodzm1=="326" or xrodzm1=="328") and not(czy_uprawniony) ) rejwstawp_s["ce:lista1","@"+symlisty+tostr["#numerlisty#S:0"]]
...
if((xrodzm1=="312" or xrodzm1=="313" or xrodzm1=="314" or xrodzm1=="315") and not(czy_uprawniony) ) rejwstawp_s["ce:lista1","KOREKTA"]
if((xrodzm1=="316" or xrodzm1=="317" or xrodzm1=="318" or xrodzm1=="320") and not(czy_uprawniony) ) rejwstawp_s["ce:lista1","KOREKTA"]
if((xrodzm1=="321" or xrodzm1=="322" or xrodzm1=="323" or xrodzm1=="324" or xrodzm1=="326" or xrodzm1=="328") and not(czy_uprawniony) ) rejwstawp_s["ce:lista1","KOREKTA"]
...
% KSIEGOWANIE.ALG
defzmiennaD["data_l",d_dzisiaj]
//okalert["data_l data wyp³aty/ data konca okresu jako data dokumentu ksiêgowego="+data_l]
...
//if(xpracownik=="1DL" or xpracownik=="1JL") okalert["xpracownik="+xpracownik+"$nadgodz_bd="+nadgodz_bd+"$nadgodz_bn="+nadgodz_bn+"$til_gdz_all="+til_gdz_all+"$n_normalne="+n_normalne+"$n_dodatek="+n_dodatek]
...
//if(xpracownik=="1DL" or xpracownik=="1JL") okalert["xpracownik="+xpracownik+"$nadgodz_bn="+nadgodz_bn+"$nadgodz_bnp="+nadgodz_bnp]
        wyn_dod := (nadgodz_bd+nadgodz_bdp)/til_gdz_all
        wyn_dod := (wyn_dod*procnadlicz)/100
        wyn_godz  := (nadgodz_bn+nadgodz_bnp)/til_gdz_all
//if(xpracownik=="1DL" or xpracownik=="1JL") okalert["xpracownik="+xpracownik+"wyn_dod="+wyn_dod+"$wyn_godz="+wyn_godz]
